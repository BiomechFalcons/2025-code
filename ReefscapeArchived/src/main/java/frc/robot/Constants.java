...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static double kMaxSpeedMetersPerSecond = 1.5;//1.5
    public static final double kMaxAngularSpeed = 1.5 * Math.PI; // radians per second
    public static final int armDegreeForLFour = 50;
    public static final double kDirectionSlewRate = 1.2; // radians per second
    public static final double kMagnitudeSlewRate = 1.8; // percent per second (1 = 100%)
    public static final double kRotationalSlewRate = 2.0; // percent per second (1 = 100%) was at 2
